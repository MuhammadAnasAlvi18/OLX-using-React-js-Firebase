...
const Footer = () => {
  return (
    <div className="footer">
        ...
        <h1 className='footer-h1'>POPULAR CATEGORIES</h1>
        <h4 className='footer-h4'>Cars</h4>
        <h4 className='footer-h4'>Flats for rent</h4>
        <h4 className='footer-h4'>Mobile Phones</h4>
        <h4 className='footer-h4'>Jobs</h4>
        </div>
        <div className='trending'>
        <h1 className='footer-h1'>TRENDING CATEGORIES</h1>
        <h4 className='footer-h4'>Bikes</h4>
        <h4 className='footer-h4'>Watches</h4>
        <h4 className='footer-h4'>Books</h4>
        <h4 className='footer-h4'>Dogs</h4></div>
        <div className='about'>
        <h1 className='footer-h1'>ABOUT US</h1>
        <h4 className='footer-h4'>About EMPG</h4>
        <h4 className='footer-h4'>OLX Blog</h4>
        <h4 className='footer-h4'>Contact Us</h4>
        <h4 className='footer-h4'>OLX for Bussinesses</h4></div>
        <div className='olx'>
        ...
        <h4 className='footer-h4'>Privacy Policy</h4></div>
        ...
        <img src={iconsImage} alt='icons'></img>
        </div>
        </div>
        </div>
      </div>
